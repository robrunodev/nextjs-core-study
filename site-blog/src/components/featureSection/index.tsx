...
const FeatureCard = ({
  ...
  return (
    <div className="flex flex-col gap-2 rounded-lg p-6 md:p-12 bg-gray-900">
      <span className="text-body-tag text-blue-200 bg-blue-700 px-3 rounded-sm py-2 mb-4 w-fit uppercase">
        {tagText}
      </span>
...
export const FeatureSection = () => {
  return (
    <section>
      <div className="container mx-auto max-w-7xl grid gap-6 md:grid-cols-2 pb-8 px-4 pt-8 md:py-10">
        <FeatureCard
          tagText="Simples"
        ...
        <div className="col-span-full grid grid-cols-2 gap-6 bg-gray-900 p-6 md:p-12">
